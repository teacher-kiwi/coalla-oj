<template>
  <Row type="flex" justify="space-around">
    ...
    <Col v-if="submission.language === 'Block Coding'" :span="20">
      <BlocklyViewer :blocks="submission.blockly_state"></BlocklyViewer>
    </Col>
...
import BlocklyViewer from "@/pages/oj/components/BlocklyViewer";

export default {
  name: "submissionDetails",
  components: { Highlight, BlocklyViewer },
  data() {
    return {
      columns: [
        { title: this.$i18n.t("m.ID"), align: "center", type: "index" },
        {
          ...
          render: (h, params) => {
            return h(
              "Tag",
              { props: { color: JUDGE_STATUS[params.row.result].color } },
              this.$i18n.t(
  ...
  computed: {
    ...
    highlightLanguage() {
      return this.submission.language === "Block Coding"
        ? "Python3"
