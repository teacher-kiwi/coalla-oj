...
from ..views.teacher import (SchoolClassAPI, SchoolClassOrderAPI, SchoolListAPI,
                             StudentAPI, StudentNicknameAPI, StudentSheetAPI,
...
urlpatterns = [
    ...
    re_path(r"^class/order/?$", SchoolClassOrderAPI.as_view(),
            name="teacher_class_order_api"),
    re_path(r"^student/?$", StudentAPI.as_view(), name="teacher_student_api"),
    re_path(r"^student/nickname/?$", StudentNicknameAPI.as_view(),
            name="teacher_student_nickname_api"),
